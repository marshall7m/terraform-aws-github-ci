...
tf_dirs = [f'{os.path.dirname(__file__)}/fixtures/create_api', f'{os.path.dirname(__file__)}/fixtures/load_api', f'{os.path.dirname(__file__)}/fixtures/disable_api_cw_logs']
